...
class BizControllerApi {

  final Dio _dio;

  final Serializers _serializers;

  const BizControllerApi(this._dio, this._serializers);
  ...
  Future<Response<BaseResponseString>> sendVerifyCode({ 
