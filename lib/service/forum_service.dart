...
class ForumService {
  ...
  Future<FetchForumPostResponse> fetchForumPost(
    FetchForumPostRequest req,
  ) async {
    try {
      final resp = await _instance.post(
        path: '/api/v1/ice/sparkhire/forum/post/fetch',
        data: req.toJson(),
      );

      final result = FetchForumPostResponse.fromMap(resp.data);
