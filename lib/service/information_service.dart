...
class InformationService {
  ...
  Future<ListMajorResponse> listMajorList(ListMajorRequest req) async {
    try {
      final resp = await _dioInstance.post(
        path: '/api/v1/ice/sparkhire/runtime/major/list',
        data: req.toJson(),
      );

      final result = ListMajorResponse.fromJson(resp.data);
